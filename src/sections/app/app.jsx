...
const App = () => {
    return (
        <section className="app" data-aos="fade-left">
            <div className="app__wrapper">
                
                <div className="mobile">
                    <h2 className="mobile__title">Lleva PoliParking en tu bolsillo</h2>
                    <p className="mobile__description">
                        Descarga nuestra aplicación y gestiona tus parqueaderos con total comodidad. 
                        Reserva, encuentra y paga desde tu smartphone.
                    </p>
